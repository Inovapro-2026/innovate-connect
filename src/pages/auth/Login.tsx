...
export default function Login() {
  ...
  const { signIn, isAdmin, isFreelancer, isClient } = useAuth();
        ...
        >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              Não tem uma conta?{' '}
              <Link to="/auth/register" className="text-primary hover:text-primary-light font-medium transition-colors">
                Cadastre-se grátis
              </Link>
            </p>
          </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-muted-foreground">
              É administrador?{' '}
              <Link to="/admin/login" className="text-primary hover:text-primary-light transition-colors">
                Acesso admin
              </Link>
            </p>
          </div>
